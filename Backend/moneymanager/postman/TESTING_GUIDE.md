...
### Date Formats
- **LocalDate**: `yyyy-MM-dd` (e.g., `2026-02-08`)
- **LocalDateTime**: ISO-8601 format (e.g., `2026-02-08T14:30:00`)
...
**Expected Response**: Error message indicating missing authentication
...
- `amount` (Number, decimal values allowed)
...
- Date range defaults to: `startDate = LocalDate.MIN`, `endDate = LocalDate.now()`
...
- `keyword` (String, searches in `name` field, case-insensitive)
- `sortField` (String: "date", "amount", or "name")
